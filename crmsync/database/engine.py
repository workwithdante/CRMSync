...
def get_engine_new():
    ...
    """
    # Obtener detalles de conexión a la base de datos desde la configuración de Frappe
    db_user = conf.user_new
    db_password = conf.password_new
    db_host = conf.host_new
    db_port = conf.port_new
    db_name = conf.name_db_new
    db_type = conf.type_new
    db_conn = conf.connector_new
    logger = setup_logging()
